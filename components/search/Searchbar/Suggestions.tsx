...
export const action = async (props: Props, req: Request, ctx: AppContext) => {
  ...
  if (!query) {
    ...
    const suggestion = await vtex.invoke("vtex/loaders/intelligentSearch/topsearches.ts")
...
function Suggestions(
  ...
  return (
    ...
    >
      <div class="flex flex-col-reverse lg:grid grid-cols-1 sm:grid-rows-1 sm:grid-cols-[1fr_352px] overflow-x-hidden justify-end items-end">
        {hasProducts &&
